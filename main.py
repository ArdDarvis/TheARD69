...
keyboard.keymap = [
    # Soooo if i set up tuples, one the top row registers as key presses
    # You can see the keys show as indexerrors in the console
    # So, I made the keymap to only utilize the top row, and broke it out like this for visibility
